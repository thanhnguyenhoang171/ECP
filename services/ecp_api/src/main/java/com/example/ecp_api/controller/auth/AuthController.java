package com.example.ecp_api.controller.auth;
...
@Tag(name = "Authentication", description = "Public Authentication APIs: Register, login, logout, refresh token, and Google OAuth.")
