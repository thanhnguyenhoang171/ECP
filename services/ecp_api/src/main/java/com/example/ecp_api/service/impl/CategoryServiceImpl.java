    ...
    public void downloadCategoryTemplate(OutputStream outputStream) {
        ...
        List<CategoryExcelDto> samples = List.of(
                CategoryExcelDto.builder()
                        ...
                        .name("Confectionery")
                        .description("Sweets, candies, and snack foods")
                        .slug("confectionery")
                        .parentSlug("")
                        .level(1)
                        .order(1)
                ...
                CategoryExcelDto.builder()
                        ...
                        .id("") // Leave empty to create new
                        .name("Snacks")
                        .description("Various packaged snacks and chips")
                        .slug("snacks")
                ...
                CategoryExcelDto.builder()
                        ...
                        .id("") // Leave empty to create new
                        .name("Candies")
                        .description("Hard candies, gummies, and mints")
                        .slug("candies")
                        .parentSlug("confectionery")
                        .level(2)
                        .order(3)
                ...
                CategoryExcelDto.builder()
                        ...
                        .id("") // Leave empty to create new
                        .name("Biscuits")
                        .description("Cookies, crackers, and biscuits")
                        .slug("biscuits")
                        .parentSlug("confectionery")
                        .level(2)
                        .order(4)
                ...
                CategoryExcelDto.builder()
                        ...
                        .id("") // Leave empty to create new
                        .name("Dried Fruits")
                        .description("Dehydrated fruits and healthy dried snacks")
                        .slug("dried-fruits")
                        .parentSlug("confectionery")
                        .level(2)
                        .order(5)
