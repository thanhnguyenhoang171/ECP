...
public class PurchaseOrderController {
    ...
    @Operation(
            ...
            description = "Retrieve paginated list of purchase orders with advanced filtering. Supports searching by keyword (poCode, note), status, warehouse, and supplier."
    )
    @Parameters({
