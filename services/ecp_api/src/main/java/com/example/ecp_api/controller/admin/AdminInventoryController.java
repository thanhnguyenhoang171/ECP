...
public class AdminInventoryController {
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable String id) {
        ...
        return ResponseEntity.ok(ApiResponse.<Void>builder()
                .success(true).message("Inventory record deleted successfully").build());
    }
    ...
    public ResponseEntity<ApiResponse<InventoryLedgerResponse>> getLedgerDetail(@PathVariable String id) {
        return ResponseEntity.ok(ApiResponse.<InventoryLedgerResponse>builder()
                .success(true).data(inventoryService.getLedgerById(id)).build());
    }
