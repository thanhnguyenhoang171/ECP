...
const INITIAL_DATABASE: ProductItem[] = [
  {
    ...
    sku: 'BENTO-20G-RED',
    name: 'Mực Sấy Bento Thái Lan Vị Cay Ngọt',
  ...
  },
  {
    ...
    name: 'Trà Thái Xanh ChaTraMue Đậm Vị',
  ...
  },
  {
    ...
    sku: 'LAYS-SHRIMP-48G',
    name: "Snack Khoai Tây Lay's Thái Lan",
  ...
  },
  {
    ...
    name: 'Nước Tăng Lực Red Bull Thái Chai Thủy Tinh',
