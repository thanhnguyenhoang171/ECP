          ...
          <CardContent className="p-5 sm:p-8">
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5">
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input 
                            ...
                            {...field} 
                            className="pl-9 sm:pl-10 h-10 sm:h-11 bg-slate-50 border-slate-200 focus:bg-white transition-all text-sm sm:text-base disabled:opacity-60"
                          />
                        </div>
                      </FormControl>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input 
                            ...
                            disabled={isAnyLoading}
                            {...field} 
                            className="pl-9 sm:pl-10 pr-9 sm:pr-10 h-10 sm:h-11 bg-slate-50 border-slate-200 focus:bg-white transition-all text-sm sm:text-base disabled:opacity-60"
                          />
                          <button
                            type="button"
                            onClick={() => setShowPassword(!showPassword)}
                            disabled={isAnyLoading}
                            className="absolute right-3 top-3 text-slate-400 hover:text-slate-600 transition-colors disabled:opacity-50"
                          >
                ...
                <Button 
                  type="submit" 
                  className="w-full h-10 sm:h-12 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl transition-all shadow-lg active:scale-[0.98] text-sm sm:text-base disabled:opacity-60 disabled:cursor-not-allowed" 
                  disabled={isAnyLoading}
                >
                  {isLoading ? (
                    <>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-10 sm:h-11 border-slate-200 text-slate-700 hover:bg-slate-50 font-bold rounded-xl transition-all text-xs sm:text-sm flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
