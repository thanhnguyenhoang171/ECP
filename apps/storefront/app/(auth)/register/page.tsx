        ...
        <div className="bg-white py-6 px-6 sm:px-8 shadow-sm rounded-xl border border-zinc-200/80">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 px-4 bg-[#F5C542] hover:bg-[#E5B32E] text-zinc-900 font-bold rounded-lg text-xs transition-colors flex items-center justify-center gap-1.5 mt-3 shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
