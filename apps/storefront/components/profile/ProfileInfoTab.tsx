  ...
  return (
    <div className="bg-white rounded-xl border border-zinc-200/80 p-6 space-y-6">
      <div className="flex items-center justify-between pb-4 border-b border-zinc-100">
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#F5C542] text-zinc-900 text-xs font-bold rounded-lg hover:bg-[#E5B32E] transition-colors shadow-sm cursor-pointer">
